...
func (msg *MsgInstantTxVote)BtcDecode(r io.Reader, pver uint32) error{
	...
	msg.Sig,err=ReadVarBytes(r,pver,100,"read instantTxVote sig")
	if err!=nil{
		return err
	}
	return nil
...
func (msg *MsgInstantTxVote)BtcEncode(w io.Writer,pver uint32) error{
	...
	return 	WriteVarBytes(w,pver,msg.Sig)
}
...
func (msg *MsgInstantTxVote) SerializeSize() int {
	return 32+32+1+VarIntSerializeSize(uint64(len(msg.Sig)))+len(msg.Sig)
}
