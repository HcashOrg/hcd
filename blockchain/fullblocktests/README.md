...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/james-ray/hcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/james-ray/hcd/blockchain/fullblocktests
```
