...
var helpDescsEnUS = map[string]string{
	...
	"sstxinput-txid":              "Unspent instantTx output hash",
	...
	"getblockverboseresult-instantTx":                "The transaction hashes (only when verbosetx=false)",
	...
	"getrawmempool-txtype":      "Type of instantTx to return. (all/regular/tickets/votes/revocations)",
