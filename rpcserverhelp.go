...
var helpDescsEnUS = map[string]string{
	...
	"sstxinput-txid":              "Unspent aiTx output hash",
	...
	"getblockverboseresult-aiTx":                "The transaction hashes (only when verbosetx=false)",
	...
	"getrawmempool-txtype":      "Type of aiTx to return. (all/regular/tickets/votes/revocations)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"estimateaistakediff":     {(*hcjson.EstimateAiStakeDiffResult)(nil)},
	...
	"gettxlockpoolinfo":     {(*hcjson.GetTxLockpoolInfoResult)(nil)},
